...
public class ApplicationTest {
    ...
    private static void challenge() {
        ...
        try {
            System.out.println("Total of Permutations for each combination (tp): " + Permutation.getTotal(4).toString());
            System.out.println("Total of Combinations (tc): " + Combination.getTotal(n, m).toString());
            BigInteger totalArrangements = Combination.getTotal(n, m).multiply(Permutation.getTotal(m));
            System.out.println("tp * tc: " + totalArrangements.toString());
            System.out.println("Total of Arrangements: " + Arrangement.getTotal(n, m).toString());

...
public class Arrangement {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Total of Arrangements: " + getTotal(n, m).toString());
    ...
    public static int[][] arrangement(int n, int m) throws Exception {
        if (isValid(n, m)) {
            ...
            while (arrangement[0] <= equivalentValue) {
                ...
                if(arrangement[0] == 9 && arrangement[1] == 8 && arrangement[2] == 6 && arrangement[3] == 7) {
                    System.out.println("");
                }
    ...
    private static boolean isValid(int n, int m) throws Exception {
        ...
        throw new Exception("N and M must be greater than 1 and N must be grater or equal to M");
    }
